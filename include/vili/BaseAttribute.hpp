...
namespace vili
{
    ...
    template <> inline int BaseAttribute::get() const {
    ...
    template <> inline double BaseAttribute::get() const {
        if (m_dataType == Types::Float)
            return Float;
        if (m_dataType == Types::Int)
            return Int;
    ...
    template <> inline bool BaseAttribute::get() const {
    ...
    template <> inline std::string BaseAttribute::get() const {
