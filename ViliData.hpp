...
namespace mse
{
	namespace Data
	{
		...
		private:
			std::string path;
		public:
			LinkAttribute(const std::string& id, const std::string& path);
			void copy();
			template <class A>
			A* get();
		};
		...
		public:
			...
			void createElement(const int& element);
			void createElement(const bool& element);
			void createElement(const double& element);
		...
		class ComplexAttribute : public ContainerAttribute
		{
			...
			public:
				...
				void createListItem(const std::string& listID, const std::string& value);
				void generateInList(const std::string& listID);
